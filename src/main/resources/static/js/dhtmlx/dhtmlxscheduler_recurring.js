...
scheduler.config.occurrence_timestamp_in_utc = !1, scheduler.config.recurring_workdays = [1, 2, 3, 4, 5], scheduler.form_blocks.recurring = {
    _get_node: function (e) {
        ...
        if (e.form) {
            var t = scheduler.form_blocks.recurring, a = t._get_node(e.form), r = t._outer_html(a);
            return a.style.display = "none", r
        }
        return scheduler.__recurring_template
    }, _ds: {}, _get_form_node: function (e, t, a) {
        var r = e[t];
        if (!r) return null;
        if (r.nodeName) return r;
        if (r.length) for (var n = 0; n < r.length; n++) if (r[n].value == a) return r[n]
        ...
        var r = e[t];
        if (r) if (r.name == t) r.value = a; else if (r.length) for (var n = "object" == typeof a, i = 0; i < r.length; i++) (n || r[i].value == a) && (r[i].checked = n ? !!a[r[i].value] : !!a)
    }, _init_set_value: function (e, t, a) {
        function r(e) {
            for (var t = 0; t < e.length; t++) {
                var a = e[t];
                if (a.name) if (m[a.name]) if (m[a.name].nodeType) {
                    var r = m[a.name];
                    m[a.name] = [r, a]
                } else m[a.name].push(a); else m[a.name] = a
            }
        }

        function n() {
            f("dhx_repeat_day").style.display = "none",
                f("dhx_repeat_week").style.display = "none", f("dhx_repeat_month").style.display = "none", f("dhx_repeat_year").style.display = "none", f("dhx_repeat_" + this.value).style.display = "block", scheduler.setLightboxSize()
        }
        ...
        function i(e) {
            ...
            var a = "", r = d(m);
            if ("no" == r) e.end = new Date(9999, 1, 1), a = "no"; else if ("date_of_end" == r) e.end = h(_(m, "date_of_end")); else {
        ...
        function d(e) {
            var t = e.end;
            if (t.length) {
                for (var a = 0; a < t.length; a++) if (t[a].checked) return t[a].value && "on" != t[a].value ? t[a].value : a ? 2 == a ? "date_of_end" : "occurences_count" : "no"
        ...
        function l(e, t) {
            ...
            if (a.length) {
                ...
                if (r) for (var n = 0; n < a.length; n++) a[n].value == t && (a[n].checked = !0); else {
                    var i = 0;
                    switch (t) {
                        case"no":
                            i = 0;
        ...
        function s(e, t) {
            ...
            switch (e = r[0].split("_"), y[e[0]](e, t), r[1]) {
                ...
                case"":
                    ...
                    break;
                default:
                    l(m, "occurences_count"), a(m, "occurences_count", r[1])
            }
            a(m, "repeat", e[0]);
        ...
        var o = scheduler.form_blocks.recurring, _ = o._get_node_value, c = o._set_node_value;
        scheduler.form_blocks.recurring._ds = {start: a.start_date, end: a._end_date};
        var u = scheduler.date.str_to_date(scheduler.config.repeat_date), h = function (e) {
            var t = u(e);
            return scheduler.config.include_end_by && (t = scheduler.date.add(t, 1, "day")), t
        }, p = scheduler.date.date_to_str(scheduler.config.repeat_date), v = e.getElementsByTagName("FORM")[0], m = {};
        ...
        var b = {
            month: function (e, t) {
                ...
                "d" == a(m, "month_type") ? (e.push(Math.max(1, r(m, "month_count"))), t.start.setDate(a(m, "month_day"))) : (e.push(Math.max(1, r(m, "month_count2"))),
                    e.push(a(m, "month_day2")), e.push(Math.max(1, r(m, "month_week2"))), scheduler.config.repeat_precise || t.start.setDate(1)), t._start = !0
            }, week: function (e, t) {
                var a = scheduler.form_blocks.recurring._get_node_value,
                    r = scheduler.form_blocks.recurring._get_node_numeric_value;
                e.push(Math.max(1, r(m, "week_count"))), e.push(""), e.push("");
                for (var n = [], i = a(m, "week_day", !0), d = t.start.getDay(), l = !1, s = 0; s < i.length; s++) n.push(i[s]), l = l || i[s] == d;
                n.length || (n.push(d), l = !0), n.sort(), scheduler.config.repeat_precise ? l || (scheduler.transpose_day_week(t.start, n, 1, 7),
                ...
                "d" == t(m, "day_type") ? e.push(Math.max(1, a(m, "day_count"))) : (e.push("week"), e.push(1), e.push(""), e.push(""), e.push(scheduler.config.recurring_workdays.join(",")), e.splice(0, 1))
            }, year: function (e, t) {
                var a = scheduler.form_blocks.recurring._get_node_value;
                "d" == a(m, "year_type") ? (e.push("1"),
                    t.start.setMonth(0), t.start.setDate(a(m, "year_day")), t.start.setMonth(a(m, "year_month"))) : (e.push("1"), e.push(a(m, "year_day2")), e.push(a(m, "year_week2")), t.start.setDate(1), t.start.setMonth(a(m, "year_month2"))), t._start = !0
            }
        }, y = {
            week: function (e, t) {
                ...
                var a = scheduler.form_blocks.recurring._set_node_value;
                "" === e[2] ? (a(m, "month_type", "d"),
                    a(m, "month_count", e[1]), a(m, "month_day", t.start.getDate())) : (a(m, "month_type", "w"), a(m, "month_count2", e[1]), a(m, "month_week2", e[3]), a(m, "month_day2", e[2]))
            }, day: function (e, t) {
                var a = scheduler.form_blocks.recurring._set_node_value;
                a(m, "day_type", "d"), a(m, "day_count", e[1])
            }, year: function (e, t) {
                var a = scheduler.form_blocks.recurring._set_node_value;
                "" === e[2] ? (a(m, "year_type", "d"), a(m, "year_day", t.start.getDate()), a(m, "year_month", t.start.getMonth())) : (a(m, "year_type", "w"), a(m, "year_week2", e[3]), a(m, "year_day2", e[2]),
                    a(m, "year_month2", t.start.getMonth()))
            }
        };
        ...
        if (e.open) {
            var a = scheduler.form_blocks.recurring._ds, r = {};
        ...
        var e = scheduler.form_blocks.recurring, t = e._get_form();
        t.open || e._toggle_block()
    }, close: function () {
        var e = scheduler.form_blocks.recurring, t = e._get_form();
        t.open && e._toggle_block()
    }, _toggle_block: function () {
        var e = scheduler.form_blocks.recurring, t = e._get_form(), a = e._get_button();
        ...
        var n = scheduler.form_blocks.recurring, r = n._get_form();
    ...
    scheduler.addEvent = function (t, a, r, n, i) {
        ...
        if (d && scheduler.getEvent(d)) {
            var l = scheduler.getEvent(d);
            this._is_modified_occurence(l) && scheduler._add_rec_marker(l, 1e3 * l.event_length), l.rec_type && (l.rec_pattern = l.rec_type.split("#")[0]);
        }
        return d
    }
    ...
    if (this._is_virtual_event(e) || this._is_modified_occurence(t) && t.rec_type && "none" != t.rec_type) {
        e = e.split("#");
        var a = this.uid(), r = e[1] ? e[1] : t._pid_time / 1e3, n = this._copy_event(t);
        ...
        var d = this._get_rec_markers(e);
        for (var l in d) d.hasOwnProperty(l) && (e = d[l].id, this.getEvent(e) && this.deleteEvent(e, !0))
    }
    return !0
    ...
    if (this._is_virtual_event(e)) {
        ...
        var d = this._get_rec_markers(e);
        for (var l in d) d.hasOwnProperty(l) && (delete this._rec_markers[d[l].id],
            this.deleteEvent(d[l].id, !0));
        delete this._rec_markers_pull[e];
        for (var s = !1, o = 0; o < this._rendered.length; o++) this._rendered[o].getAttribute("event_id") == e && (s = !0);
    ...
    var t = this.locale, a = scheduler.config.lightbox_recurring, r = this.getEvent(e), n = r.event_pid,
    ...
    if ((n || 1 * n === 0) && r.rec_type) return d(e);
...
}(), scheduler.transponse_size = {day: 1, week: 7, month: 1, year: 12}, scheduler.date.day_week = function (e, t, a) {
    e.setDate(1), a = 7 * (a - 1);
    var r = e.getDay(), n = 1 * t + a - r + 1;
    e.setDate(a >= n ? n + 7 : n)
}, scheduler.transpose_day_week = function (e, t, a, r, n) {
    for (var i = (e.getDay() || (scheduler.config.start_on_monday ? 7 : 0)) - a, d = 0; d < t.length; d++) if (t[d] > i) return e.setDate(e.getDate() + 1 * t[d] - i - (r ? a : n));
    this.transpose_day_week(e, t, a + r, null, a)
}, scheduler.transpose_type = function (e) {
    var t = "transpose_" + e;
    if (!this.date[t]) {
        var a = e.split("_"), r = 864e5, n = "add_" + e, i = this.transponse_size[a[0]] * a[1];
        if ("day" == a[0] || "week" == a[0]) {
            var d = null;
            if (a[4] && (d = a[4].split(","), scheduler.config.start_on_monday)) {
                for (var l = 0; l < d.length; l++) d[l] = 1 * d[l] || 7;
                d.sort()
            }
            this.date[t] = function (e, t) {
                var a = Math.floor((t.valueOf() - e.valueOf()) / (r * i));
                a > 0 && e.setDate(e.getDate() + a * i), d && scheduler.transpose_day_week(e, d, 1, i)
            }, this.date[n] = function (e, t) {
                var a = new Date(e.valueOf());
                if (d) for (var r = 0; t > r; r++) scheduler.transpose_day_week(a, d, 0, i); else a.setDate(a.getDate() + t * i);
                return a
            }
    ...
    var d = i || -1, l = new Date(e.start_date.valueOf()), s = l.getHours(), o = 0;
    for (!e.rec_pattern && e.rec_type && (e.rec_pattern = e.rec_type.split("#")[0]), this.transpose_type(e.rec_pattern), scheduler.date["transpose_" + e.rec_pattern](l, r); l < e.start_date || scheduler._fix_daylight_saving_date(l, r, e, l, new Date(l.valueOf() + 1e3 * e.event_length)).valueOf() <= r.valueOf() || l.valueOf() + 1e3 * e.event_length <= r.valueOf();) l = this.date.add(l, 1, e.rec_pattern);
    for (; n > l && l < e.end_date && (0 > d || d > o);) {
        l.setHours(s);
        var _ = scheduler.config.occurrence_timestamp_in_utc ? Date.UTC(l.getFullYear(), l.getMonth(), l.getDate(), l.getHours(), l.getMinutes(), l.getSeconds()) : l.valueOf(),
            c = this._get_rec_marker(_, e.id);
        if (c) a && ("none" != c.rec_type && o++, t.push(c)); else {
            var u = new Date(l.valueOf() + 1e3 * e.event_length), h = this._copy_event(e);
            if (h.text = e.text, h.start_date = l, h.event_pid = e.id, h.id = e.id + "#" + Math.ceil(_ / 1e3), h.end_date = u, h.end_date = scheduler._fix_daylight_saving_date(h.start_date, h.end_date, e, l, h.end_date),
                h._timed = this.isOneDayEvent(h), !h._timed && !this._table_view && !this.config.multi_day) return;
            t.push(h), a || (this._events[h.id] = h, this._rec_temp.push(h)), o++
        }
        l = this.date.add(l, 1, e.rec_pattern)
    }
    ...
    if (t = t || 100, !a.rec_type) return [{start_date: a.start_date, end_date: a.end_date}];
    ...
    for (var r in this._events) {
        ...
        if (n && n.start_date < t && n.end_date > e) if (n.rec_pattern) {
            if ("none" == n.rec_pattern) continue;
            var i = [];
            this.repeat_date(n, i, !0, e, t);
            for (var d = 0; d < i.length; d++) !i[d].rec_pattern && i[d].start_date < t && i[d].end_date > e && !this._rec_markers[i[d].id] && a.push(i[d])
